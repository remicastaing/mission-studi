                    ...
                    <form>
                        <?php foreach ($colonnes as $colonne) :
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" id="inputEmail3" value="<?= $agent->$attr ?>">
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </form>
                    <div class="row mb-3">
                        <label for="inputEmail3" class="col-sm-2 col-form-label">Spécialités:</label>
                        <div class="col-sm-10">
                            <div class="alert alert-dark bg-white" role="alert">
                                <?php foreach ($agent->specialite as $specialite) : ?>
                                    <span class="badge text-bg-secondary"><?= $specialite->nom ?></span>
                                <?php endforeach; ?>
                            </div>
                        </div>
                    </div>
