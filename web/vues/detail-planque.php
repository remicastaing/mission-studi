        ...
        <div class="container">
            <div class="card w-100 text-bg-secondary ">
                <div class="h1 card-header d-grid gap-2 d-md-flex justify-content-md-end">
                    <div class="flex-fill">Planque</div>
                ...
                <div class="card-footer">
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <a href="<?= $lien_delete . "&id=" . $id ?>" class="btn btn-lg btn-danger fw-bold border-white ">Supprimer la planque</a>
                        <a href="<?= $lien_create . "&id=" . $id ?>" class="btn btn-lg btn-dark fw-bold border-white ">Modifier la planque</a>
                    </div>
                </div>
            </div>
        </div>
